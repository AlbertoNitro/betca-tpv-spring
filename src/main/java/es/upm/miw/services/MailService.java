...
public class MailService {
    ...
    public void send() {
        ...
        try {
            ...
            Logger.getLogger(this.getClass().getName()).info("E-MAIL from: " + from + "to: " + to + ", subject:" + subject);
        } catch (Exception e) {
            Logger.getLogger(this.getClass().getName()).error("MailSender: " + e.getMessage());
        }
    }
}
