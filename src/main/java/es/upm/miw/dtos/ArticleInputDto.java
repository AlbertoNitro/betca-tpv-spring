...
public class ArticleInputDto {
    ...
    public ArticleInputDto(String code, String reference, String description, BigDecimal retailPriceMin, BigDecimal retailPriceMax,
            String provider) {
        super();
        this.code = code;
    ...
    public String toString() {
        return "ArticleInputDto [code=" + code + ", reference=" + reference + ", description=" + description + ", retailPriceMin="
                + retailPriceMin + ", retailPriceMax=" + retailPriceMax + ", provider=" + provider + "]";
    }
