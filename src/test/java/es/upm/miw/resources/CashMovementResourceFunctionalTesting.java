...
public class CashMovementResourceFunctionalTesting {
    ...
    public void testCreateCashMovement() {
        ...
        restService.loginAdmin().restBuilder(new RestBuilder<byte[]>()).path(CashMovementResource.CASH_MOVEMENTS).body(cashMovementDto)
    ...
    public void testCreateCashMovementNullValue() {
        ...
        byte[] bodyResponse = restService.loginAdmin().restBuilder(new RestBuilder<byte[]>()).path(CashMovementResource.CASH_MOVEMENTS).body(cashMovementDto)
                .clazz(byte[].class).post().build();
